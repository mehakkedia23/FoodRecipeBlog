...
import Recpieitems from '../components/Recpieitems'
    ...
    <>
      <section className='home' >
        <div className ='left'>
            ...
            <button onClick={()=> { alert("you can share your recpie") ,navigate("/addRecpie")}}>Share your recpie</button>
        </div>
        <div className='right'>
            <img src={foodrcpimg2} width="320px" height="300px" ></img>
        </div>
